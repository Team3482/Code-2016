...
public class OI {
    ...
    public OI() {
        ...
        armPositionPortButton = new JoystickButton(xboxController, 3);
        armPositionPortButton.whenPressed(new ArmPositionPort());
        spinShooterButton = new JoystickButton(xboxController, 6);
        spinShooterButton.whileHeld(new SpinShooter());
        invertDirectionButton = new JoystickButton(xboxController, 4);
