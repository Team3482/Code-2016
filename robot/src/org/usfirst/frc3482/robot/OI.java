...
public class OI {
    ...
    public OI() {
        ...
        invertDirectionButton = new JoystickButton(xboxController, 7);
        invertDirectionButton.whileHeld(new InvertDirection());
        forwardFeedButton = new JoystickButton(xboxController, 3);
        forwardFeedButton.whileHeld(new FeedShooter());
        reverseFeedButton = new JoystickButton(xboxController, 4);
