...
public class RobotMap {
    ...
    public static void init() {
        ...
        chassisleftEncoder = new Encoder(8, 9, false, EncodingType.k4X);
        ...
        chassisrightEncoder = new Encoder(10, 11, false, EncodingType.k4X);
        ...
        shootershooterEncoder = new Encoder(6, 7, false, EncodingType.k4X);
        ...
        shootershooter = new TalonSRX(0);
        LiveWindow.addActuator("Shooter", "shooter", (TalonSRX) shootershooter);
        
        armlowerJoint = new TalonSRX(2);
        ...
        intakeintakeEncoder.setDistancePerPulse(1.0);
        intakeintakeEncoder.setPIDSourceType(PIDSourceType.kRate);
        intakeintake = new TalonSRX(1);
