...
public class RobotMap {
    ...
    public static SpeedController topIntake;
    public static SpeedController bottomIntake;
    ...
    public static void init() {
        ...
        topIntake = new CANTalon(0);
        LiveWindow.addActuator("Intake", "intake", (CANTalon) topIntake);
        bottomIntake = new CANTalon(4);
        LiveWindow.addActuator("Intake", "intake", (CANTalon) bottomIntake);
